...
public final class RegionUtils {
    ...
    public static int getRegionOsm(String okatoName) {
        switch (okatoName) {
            ...
            case "Карачаево-Черкесская республика" : return -109878;
            case "Дагестан" : return -109876;
            case "Ставропольский край" : return -108081;
            case "Тверская область" : return -2095259;
            case "Ивановская область" : return -85617;
            case "Удмуртская республика" : return -115134;
            ...
            case "Чукотский автономный округ" : return -151231;
            ...
            case "Республика Мордовия" : return -72196;
            ...
            case "Кабардино-Балкарская республика" : return -109879;
            case "Чеченская республика" : return -109877;
            case "Калининградская область" : return -103906;
            case "Республика Калмыкия" : return -108083;
